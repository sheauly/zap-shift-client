...
const BangladeshMap = ({ warehousesCenter }) => {
    ...
    const handleSearch = (e) => {
        ...
        if (!Array.isArray(warehousesCenter)) return;
    ...
    return (
        <div className="h-[800px] rounded-lg overflow-hidden shadow-lg relative">
            ...
            >
                ...
                {Array.isArray(warehousesCenter) &&
                    warehousesCenter.map((center, index) => (
                        <Marker
                            key={index}
...
BangladeshMap.defaultProps = {
    warehousesCenter: [], // fallback empty array if not provided
};
